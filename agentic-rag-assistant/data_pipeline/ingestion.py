...
from vectorstore.pinecone_client import ( upsert_vectors, delete_by_source, build_vector_id )
import re
...
def ingest_document(source: str):
    ...
    if not doc or not doc.get("content"):
        return { "metadata": doc, "chunks": [], "vectors": [], "inserted": 0 }
    ...
    return { "metadata": doc, "chunks": chunks, "vectors": vectors, "inserted": inserted }
